---
layout: post
title: Spiderman in Sunnyside (Part 1)
date: 2023-04-11
---
...
<img src="https://gitlab.com/qirh/blog/-/raw/static/spiderman/2016_forest_hills.jpeg" alt="2016_forest_hills" style="width:80%">
...
<img src="https://gitlab.com/qirh/blog/-/raw/static/spiderman/2017_flushing.jpeg" style="width:80%">
...
<img src="https://gitlab.com/qirh/blog/-/raw/static/spiderman/2017_flushing_actual_a.jpeg" style="width:80%">
...
<img src="https://gitlab.com/qirh/blog/-/raw/static/spiderman/2017_flushing_actual_b.jpeg" style="width:30%">
...
<img src="https://gitlab.com/qirh/blog/-/raw/static/spiderman/2017_flushing_actual_c.jpeg" style="width:30%">

    Fun fact about this building (and the imposter unisphere). In the excellent 2018 Spiderman game. [Fisk Tower](https://twitter.com/ItsDVP/status/1068611546736140288/photo/1) (the villain's headquarter) is placed across the roundabout from Trump international. The buildings do not resemble each other (archtecturally), and Fisk Tower does not have a tiny Unisphere outside. However, it has an even tinier Unisphere [inside](https://www.creativeuncut.com/gallery-35/sm-fisk-tower-lobby.html) 😂😂😂
...
<img src="https://gitlab.com/qirh/blog/-/raw/static/spiderman/2017_apt_building.jpeg" style="width:80%">
...
<img src="https://gitlab.com/qirh/blog/-/raw/static/spiderman/2017_apt_building_actual.jpeg" style="width:80%">

<div class="linebreak"></div>

* Midtown Science & Tech.
<img src="https://gitlab.com/qirh/blog/-/raw/static/spiderman/2017_school.jpeg" style="width:80%">
...
<img src="https://gitlab.com/qirh/blog/-/raw/static/spiderman/2017_school_actual.jpeg" style="width:80%">
...
<img src="https://gitlab.com/qirh/blog/-/raw/static/spiderman/2017_delmar.jpeg" style="width:80%">
...
<img src="https://gitlab.com/qirh/blog/-/raw/static/spiderman/2017_ditmars_station.jpeg" style="width:80%">

    This is what it looks like under the station (though from the opposite angle).

<img src="https://gitlab.com/qirh/blog/-/raw/static/spiderman/2017_ditmars_station_actual.jpeg" style="width:80%">

    The station has a few shops inside of it. One of them is Silver Age Comics. Which Tom Holland [visited](https://www.facebook.com/SilverAgeComics/posts/that-time-tom-holland-walked-into-silver-age-comics-dressed-up-as-spider-man-tom/1933648393585926/). Maybe he visited when they shot that scene ^

<div class="linebreak"></div>

* Then we see Spiderman in front a rainbow store. I don't know if rainbow is an actual store. But that looks like Steinway st in Astoria. Which is close to the station. I looked it up and it seems to be another set from Atlanta. But they set people did a really good job picking a set that heavily resembles these parts of Queens.
<img src="https://gitlab.com/qirh/blog/-/raw/static/spiderman/2017_rainbow.jpeg" style="width:80%">

<div class="linebreak"></div>

* Then we see Spiderman swinging over the 7 train at Roosevelt and 49th st in Woodside (bordering Sunnyside). 
<img src="https://gitlab.com/qirh/blog/-/raw/static/spiderman/2017_woodside.jpeg" style="width:80%">

    Here is that bend in real-life. I find it very interesting that the billboard sign is an ad for the Philippines. I don't know if that was the true sign at the time or if it was photoshopped in. Regardless, Woodside is the filipino neighborhood in NYC. It's known as little Manila. So I can see both possibilities being real.
<img src="https://gitlab.com/qirh/blog/-/raw/static/spiderman/2017_woodside_actual.jpeg" style="width:80%">

<div class="linebreak"></div>

* Then we see Spiderman surfing over the 7 train which is actually quite a common activity with the youth. This is when the 7 train is going into hunters point
<img src="https://gitlab.com/qirh/blog/-/raw/static/spiderman/2017_surfing.jpeg" style="width:80%">

    This is where the 7 train is going into Hunters Point Av over Sunnyside Yard. You can tell because the tracks slope down, going from an over ground train in most of Quens to an underground train (2 stops in Queens) and continue in the tunnel under the east river to reach Manhattan where it continues to be underground.
<img src="https://gitlab.com/qirh/blog/-/raw/static/spiderman/2017_surfing.jpeg" style="width:80%">

    This is the 7 train (best train in NYC) in Sunnyside looking west into Manhattan.
<img src="https://gitlab.com/qirh/blog/-/raw/static/spiderman/2017_surfing_actual.jpeg" style="width:80%">


    Then we see Spiderman swinging in front of the Astoria Blvs station again on the N/W lines. This is actually one stop before the Ditmars Blvs station that he got off of earlier
<img src="https://gitlab.com/qirh/blog/-/raw/static/spiderman/2017_astoria_blvd_station.jpeg" style="width:80%">

    Here is a beautiful sunset from the same station. In the background we see the Astoria bridge. Behind that billboard on the right is the Hellsgate bridge, which is incredibly beautiful. It actually inspired the [Sydney Harbour Bridge](https://www.news.com.au/travel/world-travel/north-america/the-surprising-history-behind-the-sister-of-sydneys-harbour-bridge/news-story/4fdbc28ee37616540c4935ec349d5e12)
<img src="https://gitlab.com/qirh/blog/-/raw/static/spiderman/2017_astoria_blvd_station_actual.jpeg" style="width:80%">
...
<img src="https://gitlab.com/qirh/blog/-/raw/static/spiderman/2017_fire_escape.jpeg" style="width:80%">
...
<img src="https://gitlab.com/qirh/blog/-/raw/static/spiderman/2017_fire_escape_actual.jpeg" style="width:80%">
...
<img src="https://gitlab.com/qirh/blog/-/raw/static/spiderman/2017_cover.jpeg" style="width:80%">
...
<img src="https://gitlab.com/qirh/blog/-/raw/static/spiderman/2017_cover_actual.jpeg" style="width:80%">
